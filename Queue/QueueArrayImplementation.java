...
public static void main(String[] args) throws NumberFormatException, IOException { 	  
   ...
   QueueArrayImplementation queue = new QueueArrayImplementation(maxSize);
   ...
   do {	
	...
	System.out.println("5. For checking the contents of the queue are full or not.");
        System.out.println("6. For checking the size of the queue.");
	System.out.println("7. For returning the front item from the queue without popping it.");
